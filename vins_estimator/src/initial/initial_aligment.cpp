...
void RefineGravity(map<double, ImageFrame> &all_image_frame, Vector3d &g, VectorXd &x, int main_cam)
{
...
bool LinearAlignment(map<double, ImageFrame> &all_image_frame, Vector3d &g, VectorXd &x, int main_cam)
{
    int all_frame_count = all_image_frame.size();
