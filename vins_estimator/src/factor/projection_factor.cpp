...
ProjectionFactor::ProjectionFactor(const Eigen::Vector3d &_pts_i, const Eigen::Vector3d &_pts_j,
                                  ...
                                  : pts_i(_pts_i), pts_j(_pts_j),
                                    my_observability(_my_observability), total_obs_val(_total_obs_val), total_camera_residual(_total_camera_residual)
{
    OBS_COEFFICIENT = true;
};
...
bool ProjectionFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    if (OBS_COEFFICIENT)
    {
    //    std::cout << "with OBS_COEFFICIENT" << std::endl << "--------------" << std::endl;
        residual = my_observability / total_obs_val * total_camera_residual * residual;
        residual = sqrt_info * residual;

        /*std::cout << "-----------------------------" << std::endl;
        std::cout << "my_observability: " << my_observability << std::endl;
        std::cout << "total_obs_val: " << total_obs_val << std::endl;
        std::cout << "total_camera_residual: " << total_camera_residual << std::endl;*/
    }
    else
    {
    //    std::cout << "===============" << std::endl << "no OBS_COEFFICIENT" << std::endl;
        residual = sqrt_info * residual;
    }
