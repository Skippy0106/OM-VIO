...
ros::Publisher pub_vio_path_obs;
nav_msgs::Path no_loop_path;
nav_msgs::Path no_loop_path_obs;
...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    if (!LOOP_CLOSURE)
    {
        ...
        // obs
        geometry_msgs::PoseStamped pose_stamped_obs;
        pose_stamped_obs.header = pose_msg->header;
        pose_stamped_obs.header.frame_id = "world";
        pose_stamped_obs.pose.position.x = vio_t.x();
        pose_stamped_obs.pose.position.y = vio_t.y();
        pose_stamped_obs.pose.position.z = vio_t.z();
        no_loop_path_obs.header = pose_msg->header;
        no_loop_path_obs.header.frame_id = "world";
        no_loop_path_obs.poses.push_back(pose_stamped_obs);
        pub_vio_path_obs.publish(no_loop_path_obs);
    }
}
...
int main(int argc, char **argv)
{
    ...
    pub_vio_path_obs = n.advertise<nav_msgs::Path>("no_loop_path_obs", 1000);
